...
This package requires [ANTLR](http://www.antlr.org/).
...
This is generated by default upon installation, or by `python setup.py develop`.

To generate the parser manually run in the `latex2sympy` directory.
